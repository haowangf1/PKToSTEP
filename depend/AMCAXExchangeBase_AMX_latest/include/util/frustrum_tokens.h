...
#define SGTPRE ( 2033) /* Region */
#define SGTPSH ( 2034) /* Shell */
#define SGTPFR ( 2035) /* Frame */
#define SGTPVF ( 2036) /* Volumetric facet */
#define SGTPVM ( 2037) /* Mangled volumetric facet */
